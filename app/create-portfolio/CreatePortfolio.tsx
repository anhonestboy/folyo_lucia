  ...
  if (isLoading) {
    return (
      <div className="flex flex-col justify-center items-center h-[calc(100vh-150px)] font-mono">
        ...
        <p className="ml-4">Creating your portfolio page...</p>
      </div>
    );
  }
      ...
      <form className="space-y-4 w-full" onSubmit={submitHandler}>
        <div className="relative">
          ...
          {!isCheckingUsername && isUsernameAvailable !== null && (
            <span
              className={`absolute right-12 top-1/2 transform -translate-y-1/2 font-mono text-sm ${isUsernameAvailable ? "text-green-500" : "text-red-500"
                }`}
            >
